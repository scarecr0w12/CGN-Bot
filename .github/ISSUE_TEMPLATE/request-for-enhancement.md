...
<!--
If you need help with SkynetBot self-hosting or usage, please go to the SkynetBot Discord instead:
...
**Explain why your suggestion would enhance this feature for all or a select group of Skynet users, and does not degrade the feature for any other Skynet users:**

<!--
Additional Details
-->

- SkynetBot version AND branch:
