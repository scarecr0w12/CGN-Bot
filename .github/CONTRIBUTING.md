...
**This repository's issues section is only for bug tracking, code contribution, questions about the inner workings of CGN-Bot/design decisions or other code-related purposes. For help on how to use the bot, please visit [our Discord Server](https://discord.gg/gDtzaS2) instead.**
