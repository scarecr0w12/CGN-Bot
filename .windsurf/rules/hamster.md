...
When working with Hamster briefs, follow the standard Git workflow patterns outlined in [git_workflow.md](.windsurf/rules/git_workflow.md):
...
- [git_workflow.md](.windsurf/rules/git_workflow.md) - Standard Git branching and PR practices
- [dev_workflow.md](.windsurf/rules/dev_workflow.md) - General Task Master development patterns
- [tasks.md](.windsurf/rules/tasks.md) - Task structure and operations
