...
These files are crucial to the core functioning of Skynet, you can call them the "engine" of Skynet, if you will.
...
*It is possible to edit the Constants.js file to modify some Skynet behavior, but make sure you understand what you're doing first*.

#### How do I decide what files are Internals?

If a file;
* Is crucial to *all* functioning of Skynet, or
...
Some of the above functionality may be written in top-level files such as master.js or SkynetBot.js
