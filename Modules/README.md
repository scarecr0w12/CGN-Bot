...
SkynetBot Modules are snippets of codes that either act as utilities to aid in development, or as stand-alone features that perform actions on their own.
...
If a Skynet feature is too large for one Module, a folder may be created to contain multiple files for that Module instead.
